...
if( !class_exists('tvlgiao_wpdance_widget_special_products') ){
	class tvlgiao_wpdance_widget_special_products extends WP_Widget {
						...
						<?php } ?>
								<div class="product_detail_wd">
									...
									<div class="product_info_wd">
										...
										<?php if($show_price) : ?>
										<span class="price"><?php echo $show_price; echo wp_kses_post($product->get_price_html()); ?></span>
										<?php else: ?>
										<span class="price" style="color:red;"><?php esc_html_e('Giá liên hệ', "wpdance"); ?></span>
										<?php endif;?>
										<?php if($show_rating) : ?>
		...
		function form( $instance ) {
			...
			<p>
				<input id="<?php echo esc_attr( $this->get_field_id('show_price')); ?>" name="<?php echo esc_attr( $this->get_field_name('show_price')); ?>" type="checkbox" <?php echo ($instance['show_price'])?'checked':'' ?> />
				<label for="<?php echo esc_attr( $this->get_field_id('show_price')); ?>"><?php esc_html_e('Show Price','wpdance'); ?></label>
			</p>
			<hr />
			<p>
