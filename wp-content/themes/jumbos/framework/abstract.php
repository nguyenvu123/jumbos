<?php
	class Tvlgiao_Wpdance_GeneralTheme{
		...
		protected function tvlgiao_wpdance_init_arr_widgets(){
			$this->tvlgiao_wpdance_arr_widgets = array('wd_social_profiles','wd_special_post','wd_emads','wd_special_products','wd_featured_header','wd_search_product');
		}
		//Include Lib
		...
		protected function tvlgiao_wpdance_init_arr_shortcodes(){
			$this->tvlgiao_wpdance_arrshortcodes = array('wd_special_girl_list_product','wd_image_slider','wd_girl_list_blog');
		}

		protected function tvlgiao_wpdance_init_arr_registervc(){
			$this->tvlgiao_wpdance_arrvisualcomposer = array('wd_vc_products_girl_list','wd_vc_image_slider','wd_vc_blog_girl_list');
		}
		// Load File
		...
		public function tvlgiao_wpdance_register_location_menu(){
			register_nav_menus(array(
		        ...
		        'menu_header' 		=> esc_html__('Menu Header', 'wpdance'),
		    ));
		}
		//Theme Support
